...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames.toLocaleString()} games. Currently, ${unfundedGames.toLocaleString()} ${(unfundedGames > 1) ? "games remain" : "game remains"} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const fundedDescription = document.createElement('p');
fundedDescription.innerHTML = displayStr;
descriptionContainer.appendChild(fundedDescription);
